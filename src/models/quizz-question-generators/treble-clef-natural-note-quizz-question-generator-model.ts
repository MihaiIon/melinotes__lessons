...
import QuizzQuestionGeneratorModel from './quizz-question-generator-model';

import { naturalNotesBetween } from "@/music-utilities";
import { randomElement, randomElements } from "@/utilities";

export default class TrebleClefNaturalNoteQuizzQuestionGeneratorModel extends QuizzQuestionGeneratorModel {
  DEFAULT_CHOICE_COUNT = 4;

  generate(): QuizzQuestionModel<NoteModel> {
    ...
    return new QuizzQuestionModel<NoteModel>({ choices, allChoices });
  }
}
